...
public class CGpsFrame extends CFrame {
    ...
    public CGpsFrame(int id) {
        super(id);
        setGpsFrame(0, 0, 0, 0F, 0F, 0F, 0F, 0F, 0F, 0);
    }

    public CGpsFrame(int id, int lo, int la, int h, float xS, float yS, float zS,
    ...
    public CGpsFrame(int id, float lo, float la, float h, float xS, float yS, float zS,
                     float xD, float yD, float zD, int nSat) {
        super(id);
    ...
    public String getSpeed(SPEED s) {
        ...
        if (s.equals(SPEED.ms))
            ...
            factor = 3.6;
        // x, y, z -> norm
        double norm = Math.sqrt(getxSpeed() * factor
